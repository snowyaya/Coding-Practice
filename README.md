...
| 56 | Pointer, Interval | [To be done]() | sort 2D array by the first value of nested array: Arrays.sort(intervals, (array1, array2) -> Integer.compare(array1[0], array2[0])); convert a list of array to a 2D array: list.toArray(new int[list.size()][]);|
